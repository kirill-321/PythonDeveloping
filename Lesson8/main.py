...
metrics = ["Миллиметры", "Сантиметры", "Децеметры", "Метры", "Киллометры"]

items1 = ttk.Combobox(values=metrics)
items1.place(relx=0.15, rely=0.1, width=150, height=30)

text1 = ttk.Label(text="в")
text1.place(relx=0.5,rely=0.11)

items2 = ttk.Combobox(values=metrics)
items2.place(relx=0.60, rely=0.1, width=150, height=30)
...
convert = ttk.Button(text="Конертировать",
